...
namespace FingerTree
{
    ...
    public abstract partial class FTreeM<T, M> : ISplittable<T, M> where T : IMeasured<M>
    {
        public abstract Monoid<M> treeMonoid { get; }

        public abstract M Measure();

        public abstract FTreeM<T, M> Push_Front(T t);
        public abstract FTreeM<T, M> Push_Back(T t);
              ...
              where U : IMeasured<V>
        {
            ...
            public V Measure()
            {
                ...
                foreach (U u in digNodes)
                    result = theMonoid.theOp(result, u.Measure());
        ...
        public class Node<U, V> : IMeasured<V> where U : IMeasured<V>
        {
            ...
            public Node(Monoid<V> aMonoid, U u1, U u2)
            {
                ...
                PreCalcMeasure = theMonoid.theOp(u1.Measure(), u2.Measure());
            }
            ...
            public Node(Monoid<V> aMonoid, U u1, U u2, U u3)
            {
                ...
                foreach(U u in theNodes)
                    PreCalcMeasure = theMonoid.theOp(PreCalcMeasure, u.Measure());
            }
    ...
    public partial class EmptyFTreeM<T, M> : FTreeM<T, M> where T : IMeasured<M>
    {
        ...
        public override FTreeM<T, M> Push_Front(T t)
        {
            return new SingleFTreeM<T, M>(theMonoid, t);
        }
        
        public override FTreeM<T, M> Push_Back(T t)
        {
            return new SingleFTreeM<T, M>(theMonoid, t);
        }
    ...
    public partial class DeepFTreeM<T, M> : FTreeM<T, M> where T : IMeasured<M>
    {
                          ...
                          Digit<T, M> backDig)
        {
            if (frontDig.digNodes.Count > 0)
            {
                ...
                PreCalcMeasure = theMonoid.zero;
                PreCalcMeasure = theMonoid.theOp(PreCalcMeasure, frontDig.Measure());
                PreCalcMeasure = theMonoid.theOp(PreCalcMeasure, innerFT.Measure());
                PreCalcMeasure = theMonoid.theOp(PreCalcMeasure, backDig.Measure());
            }
            else
            {
            ...
            if (frontDig.digNodes.Count == 4)
            {
                ...
                return new DeepFTreeM<T, M>
                     (theMonoid, 
                      ...
                      innerFT.Push_Front(new Node<T, M>(theMonoid, newFront)),
                      backDig
                      );
            }
        ...
        public override FTreeM<T, M> Push_Back(T t)
        {
            ...
            if (backDig.digNodes.Count == 4)
            {
                ...
                return new DeepFTreeM<T, M>
                    (theMonoid, 
                     frontDig,
                     innerFT.Push_Back(new Node<T, M>(theMonoid, newBack)),
                     new Digit<T, M>(theMonoid,  
        ...
        public override FTreeM<T, M> App2(List<T> ts, FTreeM<T, M> rightFT)
        {
            ...
            else if (rightFT is SingleFTreeM<T, M>)
            {
                ...
                return resultFT.Push_Back(rightFT.LeftView().head);
